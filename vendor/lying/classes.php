...
return [
    ...
    'lying\cache\FileCache' => LYING_ROOT . '/cache/FileCache.php',
    'lying\cache\Memcached' => LYING_ROOT . '/cache/Memcached.php',
    
    'lying\db\Connection' => LYING_ROOT . '/db/Connection.php',
    'lying\db\QueryBuilder' => LYING_ROOT . '/db/QueryBuilder.php',
    'lying\db\Schema' => LYING_ROOT . '/db/Schema.php',
    
    'lying\logger\DbLog' => LYING_ROOT . '/logger/DbLog.php',
    'lying\logger\FileLog' => LYING_ROOT . '/logger/FileLog.php',
    ...
    'lying\service\Secure' => LYING_ROOT . '/service/Secure.php',
    'lying\service\Service' => LYING_ROOT . '/service/Service.php',
    'lying\service\Session' => LYING_ROOT . '/service/Session.php',
];